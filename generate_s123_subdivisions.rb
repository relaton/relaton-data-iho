...
# One-shot generator: emits per-Appendix YAML records for S-123 1.0.0
# (Marine Radio Services Product Specification), derived from the
# umbrella s-123_1-0-0.yaml. Subdivisions and titles confirmed from
# metanorma-iho#344.

require "yaml"

UMBRELLA = File.join(__dir__, "data/s-123_1-0-0.yaml")
...
APPENDICES.each do |letter, subtitle|
  ...
  out = File.join(__dir__, "data/s-123appendix#{letter.downcase}_1-0-0.yaml")
