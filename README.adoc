...
Editorial groups are encoded as a contributor with role type `author` and
description `committee`, with the group represented as a subdivision of the
organization.
...
- role:
  ...
  organization:
    name:
    - content: International Hydrographic Organization
    subdivision:
    - name:
      - content: Hydrographic Services and Standards Committee
      identifier:
      - content: HSSC
